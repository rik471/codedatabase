...
class AbstractRepositoryTest extends AbstractTestCase
{
    ...
    public function test_should_return_all_wit_arguments()
    {
        $mockRepository = m::mock(AbstractRepository::class);
        $mockStd = m::mock(\stdClass::class);
        $mockStd->id = 1;
    ...
    public function test_should_return_finBy_with_columns_success()
    {
        $mockRepository = m::mock(AbstractRepository::class);
        $mockStd = m::mock(\stdClass::class);
        $mockStd->id = 1;
    ...
    public function test_should_return_finBy_empty_success()
    {
        $mockRepository = m::mock(AbstractRepository::class);
